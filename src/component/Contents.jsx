...
<>
     ...
     <div className='mt-5 border h-[20rem] w-full md:w-full lg:w-[22rem] xl:w-[28rem] shadow-xl flex flex-col justify-center items-center '>
    ...
    <div className='mt-5 border h-[20rem] w-full lg:w-[22rem] xl:w-[28rem] shadow-xl flex flex-col justify-center items-center '>
